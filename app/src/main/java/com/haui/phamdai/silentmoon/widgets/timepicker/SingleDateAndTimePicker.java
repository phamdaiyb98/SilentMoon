package com.haui.phamdai.silentmoon.widgets.timepicker;
...
import com.haui.phamdai.silentmoon.widgets.timepicker.widget.*;
...
public class SingleDateAndTimePicker extends LinearLayout {
    ...
    public SingleDateAndTimePicker(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        inflate(context, R.layout.picker_single_day_and_time, this);
